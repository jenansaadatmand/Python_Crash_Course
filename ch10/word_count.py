...
count_words(filename) # Calling the function on the filename
...
# The missing siddhartha.txt file does not affect the rest of the program's execution because python can handle the error within the function
