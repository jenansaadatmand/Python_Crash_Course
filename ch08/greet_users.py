...
# Program sends a personalized greeting to each user by sending a list of names to a function called greet_users(), which greets each person in the list individually
