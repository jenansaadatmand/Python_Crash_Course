...
#def make_pizza(size, *toppings): # python assigns the first value it receives to the parameter size, all other values that come after are stored in toppings tuple
