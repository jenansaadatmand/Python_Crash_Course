...
# pop() removes the last item from the list and keeps it in memory to be used in other places

popped_motorcycle = motorcycles.pop() # pop() the last item and assign it to a variable
print(motorcycles) # removed last item from the list
