...
# Add a new line that prints a message saying that you invite only two people for dinner
# Use pop() to remove guests from your list one at a time until only two names remain on your list
...
# Using del statement to remove permanently the last two names
del guest_list[0]
del guest_list[0]
