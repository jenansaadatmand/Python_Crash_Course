...
# Example: pull out the first bicycle in the list bicycles, resulting in list item without bracket when the user see it printed on screen
...
print(bicycles[0].title()) # string neatly formated using method .title()
...
print()
# Conventions extends to recalling the -2 second last in the list, -3 third to last in list, etc
print(bicycles[-2])
print(bicycles[-3])
print()
