...
favourite_language = 'python '  # value of a variable contains extra whitespace at end of the string
print(favourite_language)
favourite_language.rstrip() # action of stripping whitespace from the right of the string can only can be see in terminal 
