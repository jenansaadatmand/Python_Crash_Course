...
class ElectricCar(Car): # Define child class, the name of the parent class must be included in parentheses in the definition of a child class
    ...
    def __init__(self, make, model, year): # __init__() takes the information required to make a Car instance
        ...
        self.battery_size = 75  # Add a new attribute, set its initial value to 75. will be associated with all instances created from ElectricCar but will not be associated with any instance from Car parent class
...
# When modelling something from real world in code, you might find that you're adding more and more detail to a class, a growing list of attributes and methods and you files become lengthy
