...
# When modeling something from real world in code, you might find that you're adding more and more detail to a class, a growing list of attributes and methods and you files become lengthy
